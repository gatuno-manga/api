...
describe('UserBuilder', () => {
    ...
    describe('construção básica', () => {
        ...
        it('deve criar um usuário com todos os campos', () => {
            const now = new Date();
            const role: Role = { id: '1', name: 'USER', maxWeightSensitiveContent: 5 };
    ...
    describe('gerenciamento de roles', () => {
        it('deve adicionar roles como array', () => {
            const role1: Role = { id: '1', name: 'USER', maxWeightSensitiveContent: 0 };
            const role2: Role = { id: '2', name: 'ADMIN', maxWeightSensitiveContent: 10 };
        ...
        it('deve adicionar role individualmente', () => {
            const role1: Role = { id: '1', name: 'USER', maxWeightSensitiveContent: 0 };
            const role2: Role = { id: '2', name: 'MODERATOR', maxWeightSensitiveContent: 5 };
        ...
        it('deve permitir combinar withRoles e addRole', () => {
            const role1: Role = { id: '1', name: 'USER', maxWeightSensitiveContent: 0 };
            const role2: Role = { id: '2', name: 'MODERATOR', maxWeightSensitiveContent: 5 };
            const role3: Role = { id: '3', name: 'ADMIN', maxWeightSensitiveContent: 10 };
    ...
    describe('métodos de conveniência', () => {
        ...
        it('deve criar usuário admin com role fornecida', () => {
            const adminRole: Role = { id: '1', name: 'ADMIN', maxWeightSensitiveContent: 10 };
    ...
    describe('cenários de uso real', () => {
        it('deve criar usuário para seed de banco de dados', () => {
            const adminRole: Role = { id: '1', name: 'ADMIN', maxWeightSensitiveContent: 10 };
            const userRole: Role = { id: '2', name: 'USER', maxWeightSensitiveContent: 0 };
