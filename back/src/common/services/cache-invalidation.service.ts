...
export class CacheInvalidationService {
    ...
    async invalidateChapter(chapterId: string): Promise<void> {
        ...
        try {
            ...
            this.logger.error(`Error deleting cache for chapter ${chapterId}:`, error);
        }
    }
    ...
    async invalidateSensitiveContent(): Promise<void> {
        ...
        for (const pattern of patterns) {
            try {
                ...
                this.logger.error(`Error deleting sensitive content cache:`, error);
            }
        }
    }
    ...
    async invalidateByPrefix(prefix: string): Promise<void> {
        ...
        try {
            ...
            this.logger.error(`Error deleting cache with prefix ${prefix}:`, error);
        }
    }
