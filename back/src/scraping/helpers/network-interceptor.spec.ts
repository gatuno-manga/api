...
describe('NetworkInterceptor', () => {
    ...
    describe('URL Filtering', () => {
        it('should accept URL when no filters configured', () => {
            ...
            const result = interceptor['shouldAcceptUrl']('https://example.com/image.jpg');
        ...
        it('should reject URL matching blacklist term', () => {
            ...
            expect(interceptor['shouldAcceptUrl']('https://example.com/logo.png')).toBe(false);
            expect(interceptor['shouldAcceptUrl']('https://example.com/icon-small.svg')).toBe(false);
            expect(interceptor['shouldAcceptUrl']('https://ads.example.com/banner.jpg')).toBe(false);
        });
        ...
        it('should accept URL not matching blacklist', () => {
            ...
            expect(interceptor['shouldAcceptUrl']('https://cdn.example.com/chapter1/page1.jpg')).toBe(true);
        });
        ...
        it('should accept URL matching whitelist', () => {
            ...
            expect(interceptor['shouldAcceptUrl']('https://cdn.example.com/image.jpg')).toBe(true);
            expect(interceptor['shouldAcceptUrl']('https://example.com/uploads/chapters/page1.jpg')).toBe(true);
        });
        ...
        it('should reject URL not matching whitelist when configured', () => {
            ...
            expect(interceptor['shouldAcceptUrl']('https://other.com/image.jpg')).toBe(false);
        });
        ...
        it('should apply blacklist before whitelist', () => {
            ...
            expect(interceptor['shouldAcceptUrl']('https://cdn.example.com/logo.png')).toBe(false);
        });
        ...
        it('should be case insensitive', () => {
            ...
            expect(interceptor['shouldAcceptUrl']('https://example.com/logo.png')).toBe(false);
            expect(interceptor['shouldAcceptUrl']('https://example.com/ICON.svg')).toBe(false);
        });
    });
    ...
    describe('Cache operations', () => {
        it('should return undefined for non-cached URL', () => {
            const interceptor = new NetworkInterceptor(mockPage);
            expect(interceptor.getCachedImage('https://example.com/image.jpg')).toBeUndefined();
        });

        it('should check if image exists in cache', () => {
            const interceptor = new NetworkInterceptor(mockPage);
            expect(interceptor.hasImage('https://example.com/image.jpg')).toBe(false);
        });
    ...
    describe('Extension detection', () => {
        it('should return .jpg as default extension', () => {
            const interceptor = new NetworkInterceptor(mockPage);
            expect(interceptor.getExtension('https://example.com/image')).toBe('.jpg');
        });

        it('should detect .png from URL', () => {
            const interceptor = new NetworkInterceptor(mockPage);
            expect(interceptor.getExtension('https://example.com/image.png')).toBe('.png');
        });

        it('should detect .webp from URL', () => {
            const interceptor = new NetworkInterceptor(mockPage);
            expect(interceptor.getExtension('https://example.com/image.webp')).toBe('.webp');
        });

        it('should detect .gif from URL', () => {
            const interceptor = new NetworkInterceptor(mockPage);
            expect(interceptor.getExtension('https://example.com/animation.gif')).toBe('.gif');
        });
    });
