...
describe('ElementScreenshot', () => {
    ...
    beforeEach(() => {
        mockLocator = {
            ...
            boundingBox: jest.fn().mockResolvedValue({ width: 100, height: 100, x: 0, y: 0 }),
    ...
    describe('getExtension', () => {
        ...
        it('should return .jpg when format is jpeg', () => {
            const screenshot = new ElementScreenshot(mockPage, { format: 'jpeg' });
    ...
    describe('captureElement', () => {
        ...
        it('should skip small elements (< minSize)', async () => {
            mockLocator.boundingBox.mockResolvedValue({ width: 30, height: 30, x: 0, y: 0 });
            const screenshot = new ElementScreenshot(mockPage);
            const result = await screenshot.captureElement(mockLocator);
        ...
        it('should return null on error when screenshot fails', async () => {
            ...
            mockLocator.screenshot.mockRejectedValue(new Error('Screenshot failed'));
            const screenshot = new ElementScreenshot(mockPage);
