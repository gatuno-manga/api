...
describe('FileCompressorFactory', () => {
	...
	beforeEach(async () => {
		...
		mockPdfCompressor = {
			compress: jest
				.fn()
				.mockResolvedValue(Buffer.from('compressed pdf')),
	...
	describe('compress', () => {
		...
		it('deve retornar buffer original em caso de erro', async () => {
			...
			mockImageCompressor.compress = jest
				.fn()
	...
	describe('getSupportedExtensions', () => {
		...
		it('deve retornar extensões de compressores registrados', () => {
			...
			mockImageCompressor.getSupportedExtensions = jest.fn(() => [
				'.jpg',
				'.png',
			]);
